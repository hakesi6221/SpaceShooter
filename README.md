...
| アセット名 | ストアURL | 理由 |
|-------------|------------|------|
| Warped Space Shooter | https://assetstore.unity.com/packages/2d/characters/warped-space-shooter-181590 | 再配布禁止 |
| Warped Shooting Fx | https://assetstore.unity.com/packages/2d/textures-materials/abstract/warped-shooting-fx-195246 | 再配布禁止 |
...
本プロジェクトでは、Google Fonts より配布されている **Orbitron** フォントを使用しています。  
